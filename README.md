...
#### 1. appendNumber(): 
    **A. With "0" on display**
        _test 1: Click any "digit" button but ".", the digit replaces "0" on display_
##### B. With "." on  display
